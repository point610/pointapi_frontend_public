...
import {updateMyUserUsingPOST} from "@/services/pointapi_backend/userController";
      ...
      <div
        ...
        <Descriptions column={1}>
          <Descriptions.Item>
            ...
            <Input size={"large"} allowClear value={nameValue}
          ...
          <Descriptions.Item>
            ...
            <Upload
              ...
              action="http://localhost:8101/api/img/upload"
          ...
          <Descriptions.Item>
            ...
            <span style={{
              fontSize: '17px',
              width: '100px'
            }}>{userVo.userRole === 'user' ? '用户' : userVo.userRole === 'admin' ? '管理员' : '未知'}</span>
          </Descriptions.Item>
          <p></p>
          <Descriptions.Item>
                <span style={{
            ...
            <TextArea rows={3} placeholder="maxLength is 100" maxLength={100} value={profileValue}
                      onChange={handleProfileChange}/>
          </Descriptions.Item>
          <p></p>
          <Descriptions.Item>
            <Button disabled={buttonDisabled} type="primary" size={"large"} onClick={clickButton}>保存修改</Button>
          </Descriptions.Item>
        </Descriptions>
